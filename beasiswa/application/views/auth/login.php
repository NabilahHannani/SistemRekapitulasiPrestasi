      ...
      <div class="container">
        <div class="navbar-header" style="float: left; width: 100%;">
          ...
          <div class="right" style="float:left;width: 80%; margin-left: 2%;margin-top: 3%;">
             <a class="navbar-brand" href="#"><b> SISTEM REKAPITULASI PRESTASI MAHASISWA - UNIVERSITAS SUMATERA UTARA</b></a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <?php
          ...
          <?php echo form_open('auth/check_login');?>
            ...
            <button type="submit" class="btn btn-sm" style="font-size:17px;" name="login">Login</button>
            <?php echo anchor('auth/register','Register',array('class'=>'btn btn-sm','style'=>'font-size:17px;'));?>
            <?php echo form_close();?>
            <?php echo form_close();?>
        </div><!-- /col-lg-6 -->
        <div class="col-lg-6">
