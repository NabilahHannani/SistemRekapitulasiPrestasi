            ...
            <table style="text-align: center;" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              foreach($mhs->result() as $mahasiswa){
                ...
                <tr>
                 ...
                 <td><?php echo anchor('admin/editMahasiswa/'.$mahasiswa->nim,'<i class="fa fa-edit fa fa-red"></i>','class="btn btn-sm btn-success tooltips" data-placement="top" data-original-title="Edit Data"');?></td>
                </tr>
              <?php
              $no++;
            }?>
