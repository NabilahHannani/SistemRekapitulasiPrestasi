        ...
        <div class="panel-body">
          <div class="table-responsive">
            ...
            <table style="text-align: center;" class="table table-bordered">
              ...
              <tr>
               <?php echo form_open('prestasi/updateVerifikasi','role="form" class="form-horizontal" method="post"');?> 
                <td>Status Verifikasi</td>
                <td>
                      <select name="status" id="status" onchange="loadStatus()">
                        <option value="0" <?=$history['status']=='Belum Terverifikasi'?'selected':''?>>Belum Terverifikasi</option>
                        <option value="1" <?=$history['status']=='Sudah Terverifikasi'?'selected':''?>>Terverifikasi</option>
                      </select>
                </td>
              </tr>
              <tr>
            ...
            <button type="submbit" name="submit" class="btn btn-success">Simpan</button>
            </form>
          </div>         
        </div>
        <?php
