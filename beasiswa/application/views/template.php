...
<html lang="en" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Sistem Rekapitulasi Prestasi Mahasiswa</title>
        <!-- start: META -->
        <meta charset="utf-8" />
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- start: LOGO -->
                    <a id="top" class="navbar-brand" href="<?php echo base_url();?>index.php/mahasiswa/cek">
                        Rekapitulasi Data Prestasi Mahasiswa
                    </a>
                    <!-- end: LOGO -->
                </div>
                    ...
                    <ul class="nav navbar-right">
                        ...
                        <li class="dropdown current-user">
                            <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
                                <img src="<?php echo base_url();?>assets/images/person.png" style="width:30px; ;"class="circle-img" alt="">
                                <span class="username" style="font-size: 15px;"><?php echo $this->session->userdata('username') ?></span>
        ...
        <div class="main-container">
            ...
            <?php
                ...
                ?>
                    ...
                    <li>
                        <a href="<?php echo base_url();?>index.php/prestasi/profil">
                            <i class="clip-file"></i>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb" style="background-color: #34495e; color: white;">
                                <li>
                                    <i class="clip-home-3" style="color: white;"></i>
